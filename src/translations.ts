export const translations = {
  ku: {
    ...
    heroTitlePart1: "گەشتی عومرەکەت.",
    heroTitlePart2: "شوێنێکی پارێزراو و جێی متمانە.",
    heroLede: "کۆمپانیا پشتڕاستکراوەکان بدۆزەرەوە، پاکێجە تەواوەکانی عومرە بەراورد بکە، و گەشتەکەت بە ڕوونی حجز بکە — لە یەکەم گەڕانتەوە تا پشتڕاستکردنەوەی گەشتەکەت.",
    ...
    verifiedUmrahOperators: "کۆمپانیا پشتڕاستکراوەکانی عومرە",
    nextPrayer: "نوێژی داهاتوو",
    welcomePilgrim: "بەخێر بێیت، عومرەکار",
    topAgencies: "باشترین کۆمپانیاکان",
    viewAll: "بینینی هەمووی",
    home: "سەرەکی",
    bookings: "حجزەکان",
    offers: "ئۆفەرەکان",
    agencies: "کۆمپانیاکان",
    featured: "تایبەت",
    ...
    trust1Desc: "پڕۆفایلی کۆمپانیاکان کە دەتوانیت بیپشکنیت",
    trust2Title: "وردەکارییە ڕوونەکانی پاکێج",
    trust2Desc: "هۆتێلەکان، فڕینەکان، ژوورەکان و خزمەتگوزارییەکان",
    trust3Title: "گەشتێکی پارێزراو",
    trust3Desc: "پشکنینی ناسنامە و پارەدانی پارێزراو",
    trust4Title: "پشتیوانی سێ زمان لە بنەڕەتەوە",
    trust4Desc: "ئینگلیزی، عەرەبی و کوردی",
    
    // Package Explorer
    explorerEyebrow: "بازاڕەکە بپشکنە",
    explorerTitle: "گەشتێک بدۆزەرەوە کە لەگەڵت بگونجێت.",
    explorerDesc: "تەماشای هەمان وردەکارییە ڕوونەکانی پاکێجەکان بکە کە عومرەکاران دەتوانن لەناو تەوافدا بەراوردیان بکەن. ئەم ئۆفەرە نموونەییانە ڕاستەوخۆ لە زانیارییەکانی بازاڕی ئەپەکەوە دێن.",
    allPackagesFilter: "هەموو پاکێجەکان",
    byAirFilter: "بە فڕۆکە",
    byCoachFilter: "بە پاس",
    fiveStarFilter: "٥ ئەستێرە",
    packageCount: "پاکێج",
    packagesCountPlural: "پاکێجەکان",
    verifiedOperator: "کۆمپانیای پشتڕاستکراو",
    days: "ڕۆژ",
    viewPackage: "بینینی پاکێج",
    fromPerson: "لە کەسێکەوە",
    
    // Feature Section
    featureEyebrow: "بازاڕێکی تەواوی عومرە",
    featureTitle: "گەڕانی کەمتر. دڵنیایی زیاتر.",
    featureDesc: "تەواف بڕیارەکان، وردەکارییەکان، و کەسانی پشت گەشتەکەت لە یەک ئەزموونی ئارامدا کۆدەکاتەوە.",
    feature1Tag: "کۆمپانیا پشتڕاستکراوەکان",
    feature1Title: "بە متمانەوە بەراورد بکە",
    feature1Desc: "تەماشای پاکێجەکانی کۆمپانیا پشتڕاستکراوەکانی عومرە بکە، و هۆتێلەکان، گواستنەوە، ماوە، خزمەتگوزارییەکان و نرخە ڕوونەکان بۆ هەر کەسێک بەراورد بکە.",
    feature2Tag: "فلتەرە زیرەکەکان",
    feature2Title: "گەشتێک بدۆزەرەوە کە بگونجێت",
    feature2Desc: "بگەڕێ بەپێی کۆمپانیا، شار، یان هۆتێل، پاشان فلتەر بکە بەپێی بودجە، گواستنەوە، شوێنی مانەوە، ماوە، و هەڵسەنگاندنی کۆمپانیاکە.",
    feature3Tag: "حجزکردنی ڕێنماییکراو",
    feature3Title: "بەبێ دوودڵی حجز بکە",
    feature3Desc: "گەشتیاران و ژمارەی ژوورەکان دیاری بکە، ناسنامەکەت پشتڕاست بکەرەوە، پێداچوونەوە بە هەر تێچوویەکدا بکە، و بەدواداچوون بۆ دۆخی حجزەکەت لە یەک شوێندا بکە.",
    
    // Orbit app preview UI strings
    bookingSummary: "پوختەی حجزەکە",
    travellers2Double: "٢ گەشتیار · ژووری دوو کەسی",
    total: "کۆی گشتی",
    
    // How it works
    howItWorksEyebrow: "لە نییەتەوە تا بەرنامەی گەشت",
    howItWorksTitle: "گەشتێکی حجزکردنی ئاسان و ڕوون.",
    howItWorksDesc: "هەر هەنگاوێک ئەوە ڕوون دەکاتەوە کە دواتر چی ڕوودەدات. زانیاری پاکێجەکە، نرخی ژوورەکان، زانیاری گەشتیاران، پشتڕاستکردنەوەی ناسنامە، پارەدان و دۆخی حجزکردن بە بەستراوەیی دەمێننەوە.",
    joinEarlyList: "بچۆرە ناو لیستی پێشوەختە",
    
    step1Title: "دۆزینەوە",
    step1Desc: "پاکێجە هەڵبژێردراوەکان و کۆمپانیا متمانەپێکراوەکان بپشکنە.",
    step2Title: "بەراوردکردن",
    step2Desc: "وردەکارییە گرنگەکان بەرامبەر بەیەک ببینە.",
    step3Title: "حجزکردن",
    step3Desc: "حجزکردنی ڕوون هەنگاو بە هەنگاو تەواو بکە.",
    step4Title: "گەشتکردن",
    step4Desc: "بەدواداچوون بۆ گەشتەکەت بکە و پشتیوانی بە نزیکی بهێڵەرەوە.",
    
    // Connected Platform
    platformEyebrow: "یەک پلاتفۆرمی بەستراو",
    platformTitle: "دروستکراوە بۆ هەموو لایەنەکانی گەشتەکە.",
    
    rolePilgrimLabel: "بۆ عومرەکاران",
    rolePilgrimTitle: "بە متمانەوە هەڵبژێرە.",
    rolePilgrimDesc: "پاکێجەکان بدۆزەرەوە، دڵخوازەکانت پاشەکەوت بکە، حجز بکە، پارە بدە، ئاگادارکردنەوەکان وەربگرە، و گەشتەکانت لە یەک شوێنی تایبەتدا بەڕێوە ببە.",
    rolePilgrimItem1: "پاکێجە هەڵبژێردراوەکان",
    rolePilgrimItem2: "گەشتە پاشەکەوتکراوەکان و حجزەکان",
    rolePilgrimItem3: "کاتەکانی نوێژ",
    
    roleAgencyLabel: "بۆ کۆمپانیاکان",
    roleAgencyTitle: "کاروباری عومرەکەت بەڕێوە ببە.",
    roleAgencyDesc: "گەشتەکان بڵاو بکەرەوە، داواکارییەکانی حجزکردن بەڕێوە ببە، نامە بۆ عومرەکاران بنێرە، بەڵگەنامەکان بپشکنە، گەشتیاران ڕێکبخە، و داهاتەکان لە داشبۆردی کۆمپانیاکەوە بەدواداچوونیان بۆ بکە.",
    roleAgencyItem1: "گەشتەکان و بەڕێوەبردنی حجزەکان",
    ...
    roleAdminTitle: "بازاڕەکە بە متمانەپێکراوی بهێڵەرەوە.",
    roleAdminDesc: "پێداچوونەوە بە کۆمپانیاکان و گەشتەکاندا بکە، چاودێری حجزەکان بکە، دارایی کۆنترۆڵ بکە، و پشتیوانی بازاڕ لە یەک پانێڵی بەڕێوەبردنەوە بەڕێوە ببە.",
    roleAdminItem1: "پەسەندکردنی کۆمپانیاکان",
    roleAdminItem2: "چاودێریکردنی گەشت و حجزەکان",
    ...
    langSectionDesc: "تەواف بە زمانەکانی ئینگلیزی، عەرەبی و کوردیی سۆرانی دیزاین کراوە — لەگەڵ نەخشەی ڕاست بۆ چەپ (RTL) و وردەکارییە کلتوورییە ئاشناکانی سەرانسەری ئەزموونەکە.",
    
    // FAQs
    faqEyebrow: "زانیاری بەسوود",
    faqTitle: "پرسیارەکان، بە ڕوونی وەڵام دراونەتەوە.",
    faqDesc: "هەموو ئەو شتانەی کە عومرەکاران و کۆمپانیاکان پێویستە بیزانن پێش ئەوەی بچنە پاڵ تەواف.",
    
    faq1Q: "تەواف چۆن کۆمپانیاکانی عومرە پشتڕاست دەکاتەوە؟",
    faq1A: "کۆمپانیاکان پڕۆفایلی کارەکەیان و بەڵگەنامە پاڵپشتەکانیان پێشکەش دەکەن بۆ پێداچوونەوە. تەنها ئەو کۆمپانیایانەی کە چالاکن و پەسەندکراون دەتوانن وەک پشتڕاستکراو لە بازاڕەکەدا دەربکەون.",
    faq2Q: "ئایا دەتوانم پێش حجزکردن پاکێجەکان بەراورد بکەم؟",
    faq2A: "بەڵێ. تەواف ماوەی گەشت، جۆری گواستنەوە، هۆتێل، مەودای تا حەرەم، جۆری ژوور، ژەمەکان، تێچووەکان، هەڵسەنگاندنی کۆمپانیاکە، و نرخی بۆ هەر کەسێک بە یەک شێوازی ڕوون و ڕێکخراو پێشکەش دەکات.",
    faq3Q: "تەواف پشتیوانی لە چ زمانانێک دەکات؟",
    faq3A: "ئەزموونە تەواوەکە بۆ زمانەکانی ئینگلیزی، عەرەبی، و کوردیی سۆرانی دیزاین کراوە، لەوانەش ڕێکخستنی ڕاست بۆ چەپ بۆ ئەو زمانانەی بە پیتی عەرەبی دەنووسرێن.",
    faq4Q: "ئایا کۆمپانیاکان دەتوانن حجزەکان لە تەوافدا بەڕێوە ببەن؟",
    faq4A: "بەڵێ. کۆمپانیا پەسەندکراوەکان شوێنی کاری تایبەت بە خۆیان وەردەگرن بۆ ئۆفەرەکان، داواکارییەکانی حجزکردن، نامەکانی عومرەکاران، بەڵگەنامەکان، و چالاکییە داراییەکان.",
    
    // Final CTA
    finalCtaEyebrow: "ڕێگایەکی باشتر بۆ دەستپێکردن",
    finalCtaTitle: "گەشتی عومرەکەت لە تەوافەوە دەست پێدەکات.",
    finalCtaDesc: "لە یەکەم کەسەکان بە کە دەزانن کەی تەواف بەردەست دەبێت.",
    ...
    authRegisterLink: "کۆمپانیاکەت تۆمار بکە",
    authHaveAccount: "پێشتر هەژمارت هەیە؟ ",
    authSignInLink: "چوونەژوورەوە",
    authRegisterTitle: "کۆمپانیاکەت تۆمار بکە",
    authRegisterSubtitle: "داواکارییەکەت بنێرە. تیمی تەواف پێداچوونەوەی بۆ دەکات و ئاگادارت دەکاتەوە.",
    authCompanyNameLabel: "ناوی کۆمپانیا",
    authCompanyNamePh: "بۆ نموونە: گەشتی نوور",
    authContactNameLabel: "ناوی بەرپرس",
    authContactNamePh: "ناوی تەواوت",
    authPhoneLabel: "ژمارەی تەلەفۆن",
    authPhonePh: "٠٧٥٠ ٠٠٠ ٠٠٠٠",
    authCreatePasswordLabel: "وشەی نهێنی",
    authRegisterButton: "ناردنی داواکاری",
    authRegisterLoading: "داواکارییەکەت دەنێردرێت…",
    authRegisterDone: "داواکارییەکەت نێردرا",
    authRegisterDoneBody: "تیمی تەواف کۆمپانیاکەت پێداچوونەوەی بۆ دەکات. کاتێک پەسەندکرا، دەتوانیت بچیتە ژوورەوە.",
    authBackToSignIn: "گەڕانەوە بۆ چوونەژوورەوە",
    authPendingApproval: "کۆمپانیاکەت هێشتا لە ژێر پێداچوونەوەدایە. کاتێک پەسەندکرا ئاگادارت دەکەینەوە.",
    authRejected: "داواکاری کۆمپانیاکەت ڕەتکرایەوە. تکایە پەیوەندی بە پشتگیرییەوە بکە.",
    authSuspended: "کۆمپانیاکەت ڕاگیراوە. تکایە پەیوەندی بە پشتگیرییەوە بکە.",
    authRegisterFailed: "نەمانتوانی داواکارییەکەت بنێرین. تکایە دووبارە هەوڵ بدەرەوە.",
  ...
  ar: {
    ...
    authRegisterLink: "سجّل شركتك",
    authHaveAccount: "لديك حساب بالفعل؟ ",
    authSignInLink: "تسجيل الدخول",
    authRegisterTitle: "سجّل شركتك",
    authRegisterSubtitle: "أرسل طلبك وسيقوم فريق طواف بمراجعته وإبلاغك بالنتيجة.",
    authCompanyNameLabel: "اسم الشركة",
    authCompanyNamePh: "مثال: رحلات النور",
    authContactNameLabel: "اسم المسؤول",
    authContactNamePh: "اسمك الكامل",
    authPhoneLabel: "رقم الهاتف",
    authPhonePh: "٠٧٥٠ ٠٠٠ ٠٠٠٠",
    authCreatePasswordLabel: "كلمة المرور",
    authRegisterButton: "إرسال الطلب",
    authRegisterLoading: "جارٍ إرسال طلبك…",
    authRegisterDone: "تم إرسال طلبك",
    authRegisterDoneBody: "سيقوم فريق طواف بمراجعة شركتك. بمجرد الموافقة، يمكنك تسجيل الدخول.",
    authBackToSignIn: "العودة إلى تسجيل الدخول",
    authPendingApproval: "شركتك قيد المراجعة. سنبلغك بمجرد الموافقة عليها.",
    authRejected: "تم رفض طلب شركتك. يرجى الاتصال بالدعم.",
    authSuspended: "تم تعليق شركتك. يرجى الاتصال بالدعم.",
    authRegisterFailed: "تعذر إرسال طلبك. يرجى المحاولة مرة أخرى.",
  ...
  en: {
    ...
    authRegisterLink: "Register your company",
    authHaveAccount: "Already have an account? ",
    authSignInLink: "Sign in",
    authRegisterTitle: "Register your company",
    authRegisterSubtitle: "Send your application. The Tawaf team reviews it and lets you know the outcome.",
    authCompanyNameLabel: "Company name",
    authCompanyNamePh: "e.g. Noor Travel",
    authContactNameLabel: "Contact name",
    authContactNamePh: "Your full name",
    authPhoneLabel: "Phone number",
    authPhonePh: "0750 000 0000",
    authCreatePasswordLabel: "Create a password",
    authRegisterButton: "Submit application",
    authRegisterLoading: "Submitting your application…",
    authRegisterDone: "Application submitted",
    authRegisterDoneBody: "The Tawaf team will review your company. Once you're approved, you can sign in.",
    authBackToSignIn: "Back to sign in",
    authPendingApproval: "Your company is still under review. We'll let you know as soon as it's approved.",
    authRejected: "Your company application was not approved. Please contact support.",
    authSuspended: "Your company has been suspended. Please contact support.",
    authRegisterFailed: "We could not submit your application. Please try again.",
